...
const CHARACTERS = [
  ...
  { id:"jiren-dragon-ball", name:"Jiren", series:"Dragon Ball", tier:"S", cost:9, rating:90, tags:["range","aura"], role:"damage", ability:{ name:"Power of Justice", type:"role_synergy", x:8, role:"tank" } },
  { id:"gohan-dragon-ball", name:"Gohan", series:"Dragon Ball", tier:"S", cost:8, rating:89, tags:["summon","range"], role:"damage", ability:{ name:"Ranged Barrage", type:"role_synergy", x:4, role:"damage" } },
  ...
  { id:"majin-buu-dragon-ball", name:"Majin Buu", series:"Dragon Ball", tier:"A", cost:7, rating:83, tags:["mobility","element"], role:"damage", ability:{ name:"Blinding Speed", type:"role_synergy", x:4, role:"support" } },
  { id:"android-18-dragon-ball", name:"Android 18", series:"Dragon Ball", tier:"B", cost:6, rating:71, tags:["melee","element"], role:"damage", ability:{ name:"Elemental Burst", type:"role_synergy", x:4, role:"damage" } },
  { id:"trunks-dragon-ball", name:"Trunks", series:"Dragon Ball", tier:"B", cost:5, rating:69, tags:["melee","element"], role:"damage", ability:{ name:"Elemental Burst", type:"role_synergy", x:4, role:"damage" } },
  { id:"piccolo-dragon-ball", name:"Piccolo", series:"Dragon Ball", tier:"B", cost:5, rating:68, tags:["range","element"], role:"damage", ability:{ name:"Ranged Barrage", type:"role_synergy", x:4, role:"damage" } },
  ...
  { id:"ichigo-bleach", name:"Ichigo", series:"Bleach", tier:"S", cost:9, rating:92, tags:["range","barrier"], role:"damage", ability:{ name:"Getsuga Tensho", type:"role_synergy", x:7, role:"damage" } },
  ...
  { id:"yoruichi-bleach", name:"Yoruichi", series:"Bleach", tier:"B", cost:6, rating:73, tags:["range","element"], role:"damage", ability:{ name:"Ranged Barrage", type:"role_synergy", x:4, role:"damage" } },
  { id:"byakuya-bleach", name:"Byakuya", series:"Bleach", tier:"B", cost:6, rating:71, tags:["giant","barrier"], role:"captain", ability:{ name:"Titanic Frame", type:"role_synergy", x:5, role:"tank" } },
  ...
  { id:"kaido-one-piece", name:"Kaido", series:"One Piece", tier:"S", cost:9, rating:93, tags:["giant","melee"], role:"captain", ability:{ name:"Strongest Creature", type:"role_synergy", x:9, role:"tank" } },
  ...
  { id:"mihawk-one-piece", name:"Mihawk", series:"One Piece", tier:"A", cost:8, rating:85, tags:["melee","range"], role:"damage", ability:{ name:"World's Strongest Swordsman", type:"role_synergy", x:8, role:"damage" } },
  { id:"zoro-one-piece", name:"Zoro", series:"One Piece", tier:"A", cost:7, rating:82, tags:["melee","element"], role:"damage", ability:{ name:"Elemental Burst", type:"role_synergy", x:4, role:"damage" } },
  { id:"doflamingo-one-piece", name:"Doflamingo", series:"One Piece", tier:"B", cost:6, rating:76, tags:["range","mobility"], role:"captain", ability:{ name:"Blinding Speed", type:"role_synergy", x:4, role:"support" } },
  ...
  { id:"ace-one-piece", name:"Ace", series:"One Piece", tier:"B", cost:5, rating:68, tags:["range","element"], role:"damage", ability:{ name:"Ranged Barrage", type:"role_synergy", x:4, role:"damage" } },
  { id:"sanji-one-piece", name:"Sanji", series:"One Piece", tier:"B", cost:5, rating:67, tags:["melee","mobility"], role:"damage", ability:{ name:"Blinding Speed", type:"role_synergy", x:4, role:"support" } },
  { id:"crocodile-one-piece", name:"Crocodile", series:"One Piece", tier:"C", cost:4, rating:60, tags:["range","element"], role:"damage", ability:{ name:"Ranged Barrage", type:"role_synergy", x:4, role:"damage" } },
  ...
  { id:"gowther-seven-deadly-sins", name:"Gowther", series:"Seven Deadly Sins", tier:"A", cost:6, rating:80, tags:["range","element","stealth","speed","psychic"], role:"support", ability:{ name:"Elemental Burst", type:"tag_projection", x:4, role:"damage" } },
