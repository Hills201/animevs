...
const CHARACTERS = [
  ...
  { id:"mahito-jujutsu-kaisen", name:"Mahito", series:"Jujutsu Kaisen", tier:"A", cost:6, rating:84, tags:["summon","range","transform","energy","element"], role:"support", ability:{ name:"Ranged Barrage", type:"aura_buff", x:4, role:"damage" } },
  { id:"nanami-jujutsu-kaisen", name:"Nanami", series:"Jujutsu Kaisen", tier:"A", cost:5, rating:82, tags:["barrier","melee","energy","speed","mobility","range"], role:"tank", ability:{ name:"Titanic Frame", type:"role_synergy", x:5, role:"tank" } },
  ...
  { id:"todo-jujutsu-kaisen", name:"Todo", series:"Jujutsu Kaisen", tier:"A", cost:6, rating:70, tags:["melee","mobility","range","speed","energy"], role:"tank", ability:{ name:"Guard Field", type:"tag_projection", tag:"barrier" } },
  { id:"choso-jujutsu-kaisen", name:"Choso", series:"Jujutsu Kaisen", tier:"A", cost:6, rating:80, tags:["giant","barrier","melee"], role:"damage", ability:{ name:"Titanic Frame", type:"role_synergy", x:5, role:"tank" } },
  { id:"maki-jujutsu-kaisen", name:"Maki", series:"Jujutsu Kaisen", tier:"S", cost:4, rating:67, tags:["melee","mobility","aura","speed","stealth","energy"], role:"damage", ability:{ name:"Titanic Frame", type:"overwhelm", x:7, role:"support" } },
  { id:"yuji-itadori-jujutsu-kaisen", name:"Yuji Itadori", series:"Jujutsu Kaisen", tier:"A", cost:5, rating:82, tags:["mobility","melee","speed","energy"], role:"tank", ability:{ name:"Blinding Speed", type:"role_synergy", x:4, role:"support" } },
  ...
  { id:"tsunade-naruto", name:"Tsunade", series:"Naruto", tier:"S", cost:5, rating:93, tags:["melee","mobility","heal","regen","energy","aura","element"], role:"healer", ability:{ name:"Blinding Speed", type:"counter_immune", x:4, role:"healer" } },
  ...
  { id:"muzan-demon-slayer", name:"Muzan", series:"Demon Slayer", tier:"SS", cost:10, rating:98, tags:["summon","aura","melee","mobility","speed","regen","transform","energy","element"], role:"captain", ability:{ name:"Regeneration", type:"role_synergy", x:6, role:"tank" } },
  { id:"kokushibo-demon-slayer", name:"Kokushibo", series:"Demon Slayer", tier:"A", cost:7, rating:86, tags:["range","barrier"], role:"captain", ability:{ name:"Guard Field", type:"tag_projection", tag:"barrier" } },
  { id:"gyomei-demon-slayer", name:"Gyomei", series:"Demon Slayer", tier:"A", cost:7, rating:85, tags:["summon","aura"], role:"captain", ability:{ name:"Battle Aura", type:"aura_buff", x:3 } },
  { id:"akaza-demon-slayer", name:"Akaza", series:"Demon Slayer", tier:"A", cost:6, rating:82, tags:["range","aura"], role:"support", ability:{ name:"Battle Aura", type:"aura_buff", x:3 } },
  { id:"tengen-demon-slayer", name:"Tengen", series:"Demon Slayer", tier:"A", cost:6, rating:79, tags:["giant","melee"], role:"captain", ability:{ name:"Titanic Frame", type:"role_synergy", x:5, role:"tank" } },
  { id:"doma-demon-slayer", name:"Doma", series:"Demon Slayer", tier:"B", cost:5, rating:76, tags:["summon","aura"], role:"support", ability:{ name:"Battle Aura", type:"aura_buff", x:3 } },
  { id:"rengoku-demon-slayer", name:"Rengoku", series:"Demon Slayer", tier:"B", cost:5, rating:75, tags:["melee","element"], role:"captain", ability:{ name:"Elemental Burst", type:"role_synergy", x:4, role:"damage" } },
  { id:"giyu-demon-slayer", name:"Giyu", series:"Demon Slayer", tier:"B", cost:5, rating:74, tags:["summon","range"], role:"captain", ability:{ name:"Ranged Barrage", type:"role_synergy", x:4, role:"damage" } },
  { id:"shinobu-demon-slayer", name:"Shinobu", series:"Demon Slayer", tier:"B", cost:5, rating:73, tags:["mobility","element"], role:"captain", ability:{ name:"Blinding Speed", type:"role_synergy", x:4, role:"support" } },
  { id:"tanjiro-demon-slayer", name:"Tanjiro", series:"Demon Slayer", tier:"B", cost:5, rating:72, tags:["range","aura"], role:"damage", ability:{ name:"Battle Aura", type:"aura_buff", x:3 } },
  { id:"zenitsu-demon-slayer", name:"Zenitsu", series:"Demon Slayer", tier:"B", cost:5, rating:70, tags:["melee"], role:"damage", ability:{ name:"Fighting Spirit", type:"overwhelm", x:4 } },
  { id:"inosuke-demon-slayer", name:"Inosuke", series:"Demon Slayer", tier:"C", cost:4, rating:62, tags:["mobility","element"], role:"damage", ability:{ name:"Blinding Speed", type:"role_synergy", x:4, role:"support" } },
  ...
  { id:"kaido-one-piece", name:"Kaido", series:"One Piece", tier:"S", cost:8, rating:93, tags:["giant","melee","range","speed","transform","mobility","aura"], role:"captain", ability:{ name:"Strongest Creature", type:"role_synergy", x:9, role:"tank" } },
  { id:"luffy-one-piece", name:"Luffy", series:"One Piece", tier:"SS", cost:9, rating:94, tags:["melee","mobility","transform","range","giant","speed","aura"], role:"captain", ability:{ name:"Gear Five", type:"clutch", x:8 } },
  ...
  { id:"sanji-one-piece", name:"Sanji", series:"One Piece", tier:"A", cost:4, rating:76, tags:["melee","mobility","speed","energy","stealth","regen"], role:"damage", ability:{ name:"Blinding Speed", type:"role_synergy", x:4, role:"support" } },
  ...
  { id:"saitama-one-punch-man", name:"Saitama", series:"One Punch Man", tier:"SS", cost:9, rating:99, tags:["summon","range"], role:"damage", ability:{ name:"One Punch", type:"overwhelm", x:12 } },
  { id:"blast-one-punch-man", name:"Blast", series:"One Punch Man", tier:"A", cost:7, rating:87, tags:["range","mobility"], role:"damage", ability:{ name:"Blinding Speed", type:"role_synergy", x:4, role:"support" } },
  { id:"boros-one-punch-man", name:"Boros", series:"One Punch Man", tier:"A", cost:7, rating:86, tags:["summon","range"], role:"captain", ability:{ name:"Ranged Barrage", type:"role_synergy", x:4, role:"damage" } },
  { id:"garou-one-punch-man", name:"Garou", series:"One Punch Man", tier:"A", cost:7, rating:85, tags:["melee","element"], role:"damage", ability:{ name:"Hunter's Instinct", type:"adaptable" } },
  { id:"tatsumaki-one-punch-man", name:"Tatsumaki", series:"One Punch Man", tier:"A", cost:6, rating:83, tags:["summon","aura"], role:"support", ability:{ name:"Terrible Tornado", type:"aura_buff", x:5 } },
  { id:"genos-one-punch-man", name:"Genos", series:"One Punch Man", tier:"B", cost:5, rating:70, tags:["giant","melee"], role:"tank", ability:{ name:"Titanic Frame", type:"role_synergy", x:5, role:"tank" } },
  { id:"bang-one-punch-man", name:"Bang", series:"One Punch Man", tier:"B", cost:4, rating:68, tags:["barrier","element"], role:"tank", ability:{ name:"Guard Field", type:"tag_projection", tag:"barrier" } },
  ...
  { id:"metal-bat-one-punch-man", name:"Metal Bat", series:"One Punch Man", tier:"C", cost:3, rating:58, tags:["mobility","element"], role:"damage", ability:{ name:"Blinding Speed", type:"role_synergy", x:4, role:"support" } },
  { id:"atomic-samurai-one-punch-man", name:"Atomic Samurai", series:"One Punch Man", tier:"C", cost:3, rating:56, tags:["range","barrier"], role:"tank", ability:{ name:"Guard Field", type:"tag_projection", tag:"barrier" } },
  ...
  { id:"bakugo-my-hero-academia", name:"Bakugo", series:"My Hero Academia", tier:"S", cost:7, rating:86, tags:["melee","range","element","aura","speed","energy","mobility"], role:"damage", ability:{ name:"Battle Aura", type:"aura_buff", x:4 } },
  ...
  { id:"dabi-my-hero-academia", name:"Dabi", series:"My Hero Academia", tier:"A", cost:5, rating:80, tags:["range","element","mobility"], role:"damage", ability:{ name:"Guard Field", type:"tag_projection", tag:"barrier" } },
  { id:"mirko-my-hero-academia", name:"Mirko", series:"My Hero Academia", tier:"A", cost:4, rating:78, tags:["speed","mobility","melee","aura"], role:"damage", ability:{ name:"Guard Field", type:"rival_bonus", tag:"barrier", universe:"Tokyo Ghoul" } },
  { id:"aizawa-my-hero-academia", name:"Aizawa", series:"My Hero Academia", tier:"B", cost:3, rating:65, tags:["mobility","range","melee","stealth"], role:"support", ability:{ name:"Guard Field", type:"tag_projection", tag:"barrier" } },
  { id:"overhaul-my-hero-academia", name:"Overhaul", series:"My Hero Academia", tier:"B", cost:3, rating:64, tags:["melee","element","range"], role:"damage", ability:{ name:"Elemental Burst", type:"role_synergy", x:2, role:"damage" } },
  { id:"gran-torino-my-hero-academia", name:"Gran Torino", series:"My Hero Academia", tier:"B", cost:3, rating:65, tags:["range","speed","mobility","melee"], role:"support", ability:{ name:"Ranged Barrage", type:"role_synergy", x:3, role:"damage" } },
  ...
  { id:"levi-attack-on-titan", name:"Levi", series:"Attack on Titan", tier:"S", cost:6, rating:85, tags:["melee","mobility","speed","stealth","aura"], role:"vice", ability:{ name:"Humanity's Strongest", type:"role_synergy", x:7, role:"damage" } },
  { id:"zeke-attack-on-titan", name:"Zeke", series:"Attack on Titan", tier:"A", cost:4, rating:76, tags:["range","giant","regen","transform"], role:"vice", ability:{ name:"Guard Field", type:"tag_projection", tag:"barrier" } },
  { id:"reiner-titan-attack-on-titan", name:"Reiner (Titan)", series:"Attack on Titan", tier:"A", cost:4, rating:76, tags:["range","mobility","transform","regen","giant"], role:"tank", ability:{ name:"Blinding Speed", type:"role_synergy", x:4, role:"tank" } },
  { id:"mikasa-attack-on-titan", name:"Mikasa", series:"Attack on Titan", tier:"B", cost:3, rating:72, tags:["melee","speed","stealth","range","mobility"], role:"damage", ability:{ name:"Fighting Spirit", type:"overwhelm", x:4 } },
  { id:"armin-attack-on-titan", name:"Armin", series:"Attack on Titan", tier:"A", cost:4, rating:76, tags:["melee","giant","range","regen","transform"], role:"tank", ability:{ name:"Elemental Burst", type:"role_synergy", x:4, role:"damage" } },
  { id:"jean-attack-on-titan", name:"Jean", series:"Attack on Titan", tier:"B", cost:2, rating:62, tags:["mobility","range","melee","stealth"], role:"support", ability:{ name:"Blinding Speed", type:"role_synergy", x:4, role:"support" } },
  { id:"erwin-attack-on-titan", name:"Erwin", series:"Attack on Titan", tier:"B", cost:2, rating:60, tags:["aura","melee","mobility","stealth"], role:"captain", ability:{ name:"Battle Aura", type:"aura_buff", x:3 } },
  ...
  { id:"king-bradley-fullmetal-alchemist", name:"King Bradley", series:"Fullmetal Alchemist", tier:"S", cost:7, rating:86, tags:["melee","aura","range","speed","regen","mobility"], role:"captain", ability:{ name:"Battle Aura", type:"aura_buff", x:4 } },
  { id:"edward-elric-fullmetal-alchemist", name:"Edward Elric", series:"Fullmetal Alchemist", tier:"S", cost:6, rating:86, tags:["element","melee","mobility","speed","energy"], role:"vice", ability:{ name:"Ranged Barrage", type:"role_synergy", x:4, role:"damage" } },
  { id:"scar-fullmetal-alchemist", name:"Scar", series:"Fullmetal Alchemist", tier:"S", cost:6, rating:86, tags:["element","mobility","melee","energy","speed","stealth"], role:"damage", ability:{ name:"Titanic Frame", type:"counter_immune", x:5, role:"tank" } },
  ...
  { id:"alphonse-fullmetal-alchemist", name:"Alphonse", series:"Fullmetal Alchemist", tier:"A", cost:5, rating:81, tags:["giant","melee","energy","element"], role:"tank", ability:{ name:"Titanic Frame", type:"role_synergy", x:5, role:"tank" } },
  ...
  { id:"mereoleona-black-clover", name:"Mereoleona", series:"Black Clover", tier:"S", cost:7, rating:87, tags:["mobility","element","melee","aura","speed","energy"], role:"tank", ability:{ name:"Blinding Speed", type:"adaptable", x:4, role:"support" } },
  ...
  { id:"nozel-black-clover", name:"Nozel", series:"Black Clover", tier:"B", cost:3, rating:66, tags:["element","range"], role:"support", ability:{ name:"Titanic Frame", type:"role_synergy", x:5, role:"support" } },
  ...
  { id:"makima-chainsaw-man", name:"Makima", series:"Chainsaw Man", tier:"S", cost:8, rating:92, tags:["range","psychic","summon","regen","aura","stealth","energy"], role:"captain", ability:{ name:"Fighting Spirit", type:"overwhelm", x:4 } },
  ...
  { id:"denji-chainsaw-man", name:"Chainsaw Man (Denji)", series:"Chainsaw Man", tier:"S", cost:7, rating:87, tags:["transform","regen","speed","mobility","melee","range"], role:"damage", ability:{ name:"Battle Aura", type:"aura_buff", x:3 } },
  { id:"katana-man-chainsaw-man", name:"Katana Man", series:"Chainsaw Man", tier:"A", cost:4, rating:76, tags:["melee","speed","regen","transform","mobility"], role:"damage", ability:{ name:"Elemental Burst", type:"role_synergy", x:4, role:"damage" } },
  { id:"aki-chainsaw-man", name:"Aki", series:"Chainsaw Man", tier:"B", cost:3, rating:70, tags:["melee","range","summon","mobility"], role:"support", ability:{ name:"Fighting Spirit", type:"aura_buff", x:4 } },
  { id:"power-chainsaw-man", name:"Power", series:"Chainsaw Man", tier:"B", cost:3, rating:70, tags:["range","melee","mobility","regen"], role:"support2", ability:{ name:"Ranged Barrage", type:"adaptable", x:4, role:"damage" } },
  { id:"reze-chainsaw-man", name:"Reze", series:"Chainsaw Man", tier:"A", cost:5, rating:80, tags:["range","melee","mobility","speed","energy","regen"], role:"damage", ability:{ name:"Guard Field", type:"rival_bonus", tag:"barrier", universe:"Chainsaw Man" } },
  ...
  { id:"mavis-fairy-tail", name:"Mavis", series:"Fairy Tail", tier:"S", cost:7, rating:86, tags:["range","element","heal","barrier","aura","energy","regen"], role:"healer", ability:{ name:"Ranged Barrage", type:"role_synergy", x:8, role:"healer" } },
  { id:"laxus-fairy-tail", name:"Laxus", series:"Fairy Tail", tier:"A", cost:5, rating:81, tags:["melee","aura","range","element"], role:"support", ability:{ name:"Battle Aura", type:"role_synergy", x:3, role:"damage" } },
  { id:"erza-fairy-tail", name:"Erza", series:"Fairy Tail", tier:"S", cost:7, rating:87, tags:["melee","range","mobility","speed","regen","aura","energy"], role:"damage", ability:{ name:"Fighting Spirit", type:"clutch", x:7 } },
  { id:"gray-fairy-tail", name:"Gray", series:"Fairy Tail", tier:"A", cost:5, rating:80, tags:["range","element","melee","mobility","energy","speed"], role:"tank", ability:{ name:"Ranged Barrage", type:"tag_projection", tag:"barrier" } },
  { id:"jellal-fairy-tail", name:"Jellal", series:"Fairy Tail", tier:"B", cost:5, rating:70, tags:["range","barrier"], role:"captain", ability:{ name:"Guard Field", type:"tag_projection", tag:"barrier" } },
  ...
  { id:"ban-seven-deadly-sins", name:"Ban", series:"Seven Deadly Sins", tier:"S", cost:7, rating:87, tags:["aura","regen","melee","mobility","energy","speed","stealth"], role:"damage", ability:{ name:"Battle Aura", type:"role_synergy", x:3, role:"damage" } },
  { id:"merlin-seven-deadly-sins", name:"Merlin", series:"Seven Deadly Sins", tier:"A", cost:6, rating:82, tags:["barrier","element","heal","transform","energy","psychic"], role:"healer", ability:{ name:"Guard Field", type:"tag_projection", tag:"barrier" } },
  { id:"gowther-seven-deadly-sins", name:"Gowther", series:"Seven Deadly Sins", tier:"A", cost:5, rating:80, tags:["range","element","stealth","speed","psychic"], role:"support", ability:{ name:"Elemental Burst", type:"role_synergy", x:4, role:"damage" } },
