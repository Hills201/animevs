...
const CHARACTERS = [
  ...
  { id:"doma-demon-slayer", name:"Doma", series:"Demon Slayer", tier:"S", cost:8, rating:76, tags:["regen","melee","element","range","mobility","speed","transform"], role:"vice", ability:{ name:"Battle Aura", type:"counter_immune", x:3 } },
